...
import profileImage1 from 'assets/images/profiles/profile-1.png'
import profileImage2 from 'assets/images/profiles/profile-2.png'
                        ...
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="app-utilities col-auto">
                                        ...
                                        <div className="dropdown-menu-content">
                                            <div className="item p-3">
                                                <div className="row gx-2 justify-content-between align-items-center">
                                                    <div className="col-auto">
                                                        <img className="profile-image" src={profileImage1} alt="" />
                                                    </div>
                                                    {/*//col*/}
                                                    <div className="col">
                                                        <div className="info">
                                                ...
                                                {/*//row*/}
                                                <Link className="link-mask" to="/app/notifications"></Link>
                                            </div>
                                            {/*//item*/}
                                            <div className="item p-3">
                                                <div className="row gx-2 justify-content-between align-items-center">
                                            ...
                                            <div className="item p-3">
                                                <div className="row gx-2 justify-content-between align-items-center">
                                                    <div className="col-auto">
                                                        <img className="profile-image" src={profileImage2} alt="" />
                                                    </div>
                                                    {/*//col*/}
                                                    <div className="col">
                                                        <div className="info">
                                ...
                                <div className="app-utility-item app-user-dropdown dropdown">
                                    <a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src={userImage} alt="user profile" /></a>
