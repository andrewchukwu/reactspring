    ...
    return (<div id="app-sidepanel" className="app-sidepanel">
        ...
        <div className="sidepanel-inner d-flex flex-column">
            ...
            <div className="app-branding">
                <a className="app-logo" href="index.html"><img className="logo-icon me-2" src={logoImage} alt="logo" />
                <span className="logo-text">SPRING PORTAL</span>
                <h6 className="small">CREDIT RATING AGENCY</h6>
                </a>
            ...
            <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
                ...
                <li className="nav-item">
                        <Link className="nav-link" to="/acount">
                            ...
                            <span className="nav-link-text">to Account</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="about">
                            ...
                            <span className="nav-link-text">to About</span>
                        </Link>
                    </li>

                    <li className="nav-item">
                        <Link to="/" className="nav-link " to="/app">
                            <span className="nav-icon">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M7.646 1.146a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 .146.354v7a.5.5 0 0 1-.5.5H9.5a.5.5 0 0 1-.5-.5v-4H7v4a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .146-.354l6-6zM2.5 7.707V14H6v-4a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4h3.5V7.707L8 2.207l-5.5 5.5z" />
                                    <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                            ...
                            <span className="nav-link-text">to /</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item has-submenu">
                        ...
                        <div id="submenu-3" className="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                            <ul className="submenu-list list-unstyled">
                                <li className="submenu-item"><Link className="submenu-link" to="/app/products/boost">Boost</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/products/creditcards">Credit Cards</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/products/loans">Loans</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/products/carfinance">Car Finance</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/products/loans">Loans</Link></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="/app/documents">
                            <span className="nav-icon">
                    ...
                    <li className="nav-item has-submenu">
                        ...
                        <div id="submenu-1" className="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul className="submenu-list list-unstyled">
                                <li className="submenu-item"><Link className="submenu-link" to="/app/notifications">Notifications</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/account">Account</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/app/settings">Settings</Link></li>
                            </ul>
                        </div>
                    </li>
                    <li className="nav-item has-submenu">
                        ...
                        <div id="submenu-2" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                            <ul className="submenu-list list-unstyled">
                                <li className="submenu-item"><Link className="submenu-link" to="/auth/login">Login</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/auth/signup">Signup</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/auth/reset-password">Reset password</Link></li>
                                <li className="submenu-item"><Link className="submenu-link" to="/404">404 page</Link></li>
                            </ul>
                        </div>
                    </li>
