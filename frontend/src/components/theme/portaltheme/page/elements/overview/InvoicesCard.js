        ...
        <div className="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
            <div className="app-card-header p-3 border-bottom-0">
                <div className="row align-items-center gx-3">
                    ...
                    <div className="col-auto">
                        <h4 className="app-card-title">Credit Cards</h4>
                    </div>
                </div>
            </div>
            <div className="app-card-body px-4">

                <div className="intro">Looking to borrow more. Check which card you are pre-approved for. Searching does not affect your credit score.</div>
            </div>
            <div className="app-card-footer p-4 mt-auto">
                <a className="btn app-btn-secondary" href="/#">Find pre-approved cards</a>
            </div>
        </div>
    </div>);
}
