    ...
    return (<div className="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
        <div className="inner">
            <div className="app-card-body p-3 p-lg-4">
                <h3 className="mb-3">Upgrade to Spring CRA pro to understand what is affecting your score.</h3>
                <div className="row gx-5 gy-3">
                    <div className="col-12 col-lg-9">

                        <div>Getting your score is free. You can access your report by registering for Spring CRA pro.</div>
                    </div>
