                        ...
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="app-utilities col-auto">
                                    ...
                                    <div className="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
                                        ...
                                        <div className="dropdown-menu-content">
                                            ...
                                            <div className="item p-3">
                                                <div className="row gx-2 justify-content-between align-items-center">
                                                    <div className="col-auto">
                                                        <img className="profile-image" src="themes/portaltheme/assets/images/profiles/profile-2.png" alt="" />
                                                    </div>
                                                    {/*//col*/}
                                                    <div className="col">
                                                        <div className="info">
                                ...
                                <div className="app-utility-item app-user-dropdown dropdown">
                                    <a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="themes/portaltheme/assets/images/user.png" alt="user profile" /></a>
